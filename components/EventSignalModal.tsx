...
import { X, MapPin, Clock, Calendar, Zap, Bookmark, Navigation, Share2, Info, Activity, ArrowRight, Sparkles, ChevronUp, Heart, ExternalLink, Map as MapIcon } from 'lucide-react';
          ...
          {isFull && (
            <>
              ...
              <div className="w-full md:w-1/2 h-[40vh] md:h-auto relative shrink-0">
                <Image src={event.image_url} alt={event.title} fill className="object-cover" referrerPolicy="no-referrer" />
              ...
              <div className="flex-1 p-8 md:p-12 flex flex-col relative">
                ...
                <div className="flex-1 flex flex-col justify-center space-y-8">
                  ...
                  <div className="space-y-6">
                    ...
                    {event.tags && (
                      <div className="flex flex-wrap gap-2">
                        {event.tags.map(tag => (
                          <span key={tag} className="px-3 py-1 rounded-full bg-white/5 border border-white/5 text-[8px] font-mono text-white/40 uppercase tracking-widest hover:text-white hover:bg-white/10 transition-colors cursor-default">
                            #{tag}
                          </span>
                        ))}
                      </div>
                  ...
                  <div className="flex gap-3 pt-4">
                    ...
                    >
                      <Zap className={`w-4 h-4 ${isSaved ? 'fill-black' : ''}`} />
