...
interface SavedEventsProps {
  isVisible: boolean;
  onClose: () => void;
  savedEvents: RuntimeEventProjection[];
}
                      ...
                      <div className="flex gap-6">
                        ...
                        <div className="flex-1 min-w-0 flex flex-col justify-center space-y-2">
                          <div className="flex items-start justify-between gap-4">
                            <h3 className="text-xl font-black uppercase italic tracking-tight text-white truncate">
                              {event.title}
                            </h3>
                ...
                <div className="h-full flex flex-col items-center justify-center text-center space-y-8 px-12">
                  ...
                  <div className="space-y-3">
                    ...
                    <p className="text-white/30 font-mono text-[11px] leading-relaxed uppercase tracking-widest">
                      Explore the city grid and bookmark nightlife signals to
                      build your cultural itinerary.
                    </p>
                  </div>
                  <button
                    onClick={onClose}
            ...
            {savedEvents.length > 0 && (
              <div className="p-12 bg-black/60 border-t border-white/5 flex items-center justify-between">
                <div className="space-y-1">
                  ...
                  <p className="text-2xl font-black italic text-brand-primary">
                    {savedEvents.length}
                  </p>
                </div>
