...
export function useCalendarOverlayState(selectedEventId: Ref<string | null>) {
  ...
  function buildCalendarFeedQuery(
    ...
    return {
      ...
      marketTimezone: latestMapFeedQuery.marketTimezone,
      fromUtc: latestMapFeedQuery.fromUtc,
      toUtc: latestMapFeedQuery.toUtc,
      referenceInstantUtc: latestMapFeedQuery.referenceInstantUtc,
